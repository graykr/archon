...
isset($_ARCHON) or die();
   ...
   //
	...
	/*echo("<div class='morelesslink' style='float: right'>show more/less</div>");*/

  //  if(!$_ARCHON->Error)
  //  {
        $arrCollections = $_ARCHON->getCollectionsForChar($in_Char, true, $_SESSION['Archon_RepositoryID'], array('ID', 'Title', 'SortTitle', 'ClassificationID', 'InclusiveDates', 'CollectionIdentifier','Extent','ExtentUnit','AltExtentStatement','Abstract','Scope'));
