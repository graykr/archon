...
/** To build reading room request link */
...
{ ?><div id="faauthor"><p style="font-weight:bold" class="center">By <?php echo($objCollection->getString('FindingAidAuthor')); ?></p></div> <?php } ?>
...
<?php
   echo("<a href='https://forms.illinois.edu/sec/7016277' target='_blank'><img src='" . $_ARCHON->PublicInterface->ImagePath . "/email.png' alt='Email Us' /></a> <a href='https://forms.illinois.edu/sec/7016277' target='_blank'>Email Us</a>");
   ?>
</div>
...
{ ?><h2 style='text-align:left'><a name="abstract"></a>Abstract</h2><div class="indent-text"><?php echo($objCollection->getString('Abstract')); ?></div><?php } ?>
<?php if($objCollection->Scope)
{ ?><h2 style='text-align:left'><a name="scopecontent"></a>Scope and Contents of the Materials</h2><div class="indent-text"><?php echo($objCollection->getString('Scope')); ?></div><?php } ?>
