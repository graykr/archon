...
<div id="bottom">
   ...
   if(defined('PACKAGE_COLLECTIONS'))
   {
	  ...
	  //echo("<div id='emaillink'>Contact Us: <a href='http://archives.library.illinois.edu/ala/contact-us/'>Email Form</a></div>\n");
	  echo("<div id='emaillink'><a href='http://archives.library.illinois.edu/ala/contact-us/'>Contact ALA Archives</a></div>\n");
