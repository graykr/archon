...
$_ARCHON->PublicInterface->addNavigation('RBML', 'http://library.illinois.edu/rbx/', true);
...
<?php
                  if($_ARCHON->Security->isAuthenticated())
                     ...
                     {
                        echo("<a href='#archoninfo' onclick='$(window).scrollTo(\"#archoninfo\"); if($(\"#userlogin\").is(\":visible\")) $(\"#loginlink\").html(\"Log In\"); else $(\"#loginlink\").html(\"Hide\"); $(\"#userlogin\").slideToggle(\"normal\"); $(\"#ArchonLoginField\").focus(); return false;'>Log In</a>");
                     }
