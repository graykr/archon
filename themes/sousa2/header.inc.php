   ...
   <body>
      ...
      <div id="top">
         ...
         <div id="logosearchwrapper">
            ...
            <div id="logo"><a href="http://archives.library.illinois.edu/sousa/" ><img src="<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/logo.png" alt="logo" /></a> </div>
               ...
               <form action="index.php" accept-charset="UTF-8" method="get" onsubmit="if(!this.q.value) { alert('Please enter search terms.'); return false; } else { return true; }">
                  <div>
                     ...
                     <span id="searchWord">Search:&nbsp;</span>
	                     <select id="searchtype" name="setrepositoryid" required="">
	                     	<option value="2">Sousa Archives Only</option>
	                     	<option value="0">All University Archives</option>
                     	</input>
                     </select>
                     <input type="text" size="31" title="search" maxlength="150" name="q" id="qfa" value="<?php echo(encode($_ARCHON->QueryString, ENCODE_HTML)); ?>" tabindex="100" />
         ...
         <div id="researchblock">
            <?php
                     if($_ARCHON->Security->isAuthenticated())
                     {
                        ...
                        echo("<span class='bold'>Welcome, " . $_ARCHON->Security->Session->User->toString() . "<a href='$strLogout'>Logout</a>" . "</span><br/>");
                     ...
                     if(!$_ARCHON->Security->userHasAdministrativeAccess())
                     {
                        ...
                        echo(" | <a href='mailto:sousa@illinois.edu?subject=" . urlencode($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) . "'>Contact Us</a>");
                        if($_ARCHON->Security->isAuthenticated())
                        {
